<h1 align="center" style="font-size: 50px;">Welcome to ImageRenaming project 👋</h1>
...
[![Contributions](https://quentium.fr/+img/github/contributions.svg)](https://github.com/QuentiumYT/ImageRenaming/pulls)&nbsp;
[![Tested on Python 3.7](https://quentium.fr/+img/github/python.svg)](https://www.python.org/downloads)&nbsp;
[![License](https://quentium.fr/+img/github/mit.svg)](https://github.com/QuentiumYT/ImageRenaming/blob/master/LICENSE)&nbsp;
...
>#### Rename all pictures in the selected folder by name growing, based on their creation datebash
<p align="center"><img src="https://quentium.fr/+img/github/ImageRenaming.gif"></p>
...
**WINDOWS:** Simply click twice on `ImageRenaming.pyw` or run using IDLE

**LINUX:** Not tested yet for GUIs
```bash
python3 ImageRenaming.pyw
```
